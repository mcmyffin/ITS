...
default_days            = 28                  # How long to certify for
default_md              = sha256                  # MD to use
...
openssl req -new \
    ...
    -subj "C=DE/O=haw-hamburg/OU=informatik/CN=sadim.informatik.haw-hamburg.de"
...
#echo sadim.informatik.haw-hamburg.de
...
# echo "<docker-IP> domainadress.de" >> /etc/hosts (aber im ausführenden Rechner und nicht im Docker!!!)
